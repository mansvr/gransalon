...
Next.js App Router · React 19 · Tailwind v4 · [nuqs](https://nuqs.dev/) · [shadcn](https://ui.shadcn.com/) · [Fonttrio poster](https://github.com/kapishdima/fonttrio) (Oswald + Barlow + Inconsolata) · static catalog JSON · Vercel.
